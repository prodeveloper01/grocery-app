...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2021 at 12:39 PM
...
INSERT INTO `about` (`id`, `about_content`, `image`, `logo`, `favicon`, `fb`, `twitter`, `insta`, `android`, `ios`, `copyright`, `title`, `short_title`, `mobile`, `email`, `address`, `created_at`, `updated_at`) VALUES
(1, 'About is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. About is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 'about-6040d321e83a5.jpg', 'logo-603cc61465144.png', 'favicon.png', 'https://www.facebook.com/', 'https://twitter.com/', 'https://www.instagram.com/', 'https://play.google.com/store', 'https://www.apple.com/in/itunes/', 'Copyright © 2021.All Rights Reserved.', 'Grocery | Single Grocery Store Website & Delivery Boy App With Admin Panel', NULL, '+917016428845', 'infotechgravity@gmail.com', '518-519, Amby Valley Arcade, VIP Cir, nr. Essar Petroleum, Uttran, Surat, Gujarat 394105', '2021-10-21 10:19:02', '2021-08-13 00:25:45');
...
CREATE TABLE `banner` (
  ...
  `image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cat_slug` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `item_slug` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `item` (
  ...
  `ingredient_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `order` (
  ...
  `payment_type` int(255) NOT NULL COMMENT '0 = COD',
  ...
  `ordered_date` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Stripe', 1, 'pk_test_51HVsZRLKgWGtoXaz55vRbIKUOnfO3d5ONZ0kFvCfUUzCoKJ2poD4rjVYBxKygvZhVBcv5VnUcYU2QFjYukcfBPsD00ljf7eoUh', 'sk_test_51HVsZRLKgWGtoXaz2VWYK0XT4FjOinBELkdjMuEMoBVYChCu3lUUmhv9o6FtbAQhWdyOMANwkDyXzxW8KmtrFNiQ009xR3GbaZ', '-', '-', 1, '2020-12-29 07:45:15', '2021-01-18 09:16:07'),
(2, 'RazorPay', 1, 'rzp_test_4r8y0wDMkrUDFn', 'nEDuJlpL3x2BqHxYlQBYtrto', '-', '-', 1, '2020-12-29 07:45:15', '2021-01-18 09:16:22'),
(3, 'COD', 1, '', '', NULL, NULL, 1, '2020-12-29 07:54:50', '2021-01-18 09:16:25');
...
(1, '<p><strong>Terms &amp; Condition</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>\n\n<p><strong>Terms &amp; Condition</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>', '2020-10-13 12:37:35', '2021-03-01 07:13:53');
...
(1, 'Monday', '12:00am', '11:30pm', 2, '2021-03-05 12:07:03', '2021-03-05 06:37:03'),
(2, 'Tuesday', '12:00am', '11:45pm', 2, '2021-03-05 12:07:03', '2021-03-05 06:37:03'),
(3, 'Wednesday', '12:00am', '11:30pm', 2, '2021-03-05 12:07:03', '2021-03-05 06:37:03'),
(4, 'Thursday', '12:00am', '11:30pm', 2, '2021-03-05 12:07:03', '2021-03-05 06:37:03'),
(5, 'Friday', '12:00am', '11:30pm', 2, '2021-03-05 12:07:04', '2021-03-05 06:37:04'),
(6, 'Saturday', '12:00am', '11:30pm', 2, '2021-03-05 12:07:04', '2021-03-05 06:37:04'),
(7, 'Sunday', '12:00am', '11:30pm', 2, '2021-03-05 12:07:04', '2021-03-05 06:37:04');
...
CREATE TABLE `users` (
  ...
  `is_available` int(11) NOT NULL DEFAULT 1 COMMENT '1 = Yes , 2 = No',
  `otp` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '1 = Yes , 2 = No',
...
INSERT INTO `users` (`id`, `name`, `email`, `mobile`, `profile_image`, `password`, `login_type`, `google_id`, `facebook_id`, `type`, `tax`, `delivery_charge`, `currency`, `max_order_qty`, `min_order_amount`, `max_order_amount`, `lat`, `lang`, `map`, `firebase`, `timezone`, `token`, `referral_amount`, `wallet`, `referral_code`, `is_available`, `otp`, `is_verified`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'admin@gmail.com', '', 'profile-5ee90c4cdce2c.jpg', '$2y$10$4bOP9mlX9RaM9rh1gj8p7OQwAz4XYKmbEa5JOquLKdKeRykAg.Ek6', NULL, NULL, NULL, 1, '5', '10', '$', 10, 10, 1000, '40.730610', '-73.935242', 'map key', 'firebase key', 'Asia/Kolkata', '', '50', NULL, NULL, 1, '', NULL, '2020-06-05 14:21:20', '2021-10-19 11:15:47');

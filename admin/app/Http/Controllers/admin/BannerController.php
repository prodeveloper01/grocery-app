...
class BannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            $category = Category::select('slug')->where('id',$request->cat_id)->first();
            $item = Item::select('slug')->where('id',$request->item_id)->first();
            ...
            $banner->cat_slug =$category->slug;
            $banner->item_slug =$item->slug;
            $banner->save();

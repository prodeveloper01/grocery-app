...
class ItemController extends Controller
{
    ...
    public function index() {
        ...
        $getitem = Item::select('item.*')->with('category')->with('variation')->join('categories','item.cat_id','=','categories.id')->where('item.is_deleted','2')->where('categories.is_available','1')->get();

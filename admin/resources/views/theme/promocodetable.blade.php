    ...
    <tbody>
        ...
        <tr id="dataid{{$promocode->id}}">
            ...
            @else
                <td>
                    @if ($promocode->is_available == 1)
                        <a class="badge badge-success px-2" onclick="StatusUpdate('{{$promocode->id}}','2')" style="color: #fff;">Available</a>
                    @else
                        <a class="badge badge-danger px-2" onclick="StatusUpdate('{{$promocode->id}}','1')" style="color: #fff;">Unavailable</a>
                    @endif
                </td>
                <td>
                    <span>
                        ...
                        <!-- <a class="badge badge-danger px-2" onclick="Delete('{{$promocode->id}}')" style="color: #fff;">Delete</a> -->
                    </span>
                </td>
            @endif
        </tr>

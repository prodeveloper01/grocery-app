    ...
    <div class="card">
        ...
        <div class="card-body">
        	@if (env('Environment') == 'sendbox')
        		...
        		<button type="button" onclick="myFunction()" class="btn mb-2 btn-sm btn-danger">Delete</button>
        	@else
        	    <button type="button" onClick="EditDocument('{{$itemimage->id}}')" class="btn mb-2 btn-sm btn-primary">Edit</button>
        	    <button type="button" onclick="DeleteImage('{{$itemimage->id}}','{{$itemimage->item_id}}')" class="btn mb-2 btn-sm btn-danger">Delete</button>
        	@endif  

                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="offer_name" placeholder="Enter Offer Name" id="offer_name">
                        </div>
                        <div class="form-group">
                            <label for="offer_code" class="col-form-label">Offer Code:</label>
                            <input type="text" class="form-control" name="offer_code" placeholder="Enter Offer Code" id="offer_code">
                        </div>
                        <div class="form-group">
                            <label for="offer_amount" class="col-form-label">Offer in percentage (%):</label>
                            <input type="text" class="form-control" name="offer_amount" placeholder="Enter Offer in percentage (%)" id="offer_amount">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="getoffer_name" placeholder="Enter Offer Name" id="getoffer_name">
                            </div>
                            <div class="form-group">
                                <label for="getoffer_code" class="col-form-label">Offer Code:</label>
                                <input type="text" class="form-control" name="getoffer_code" placeholder="Enter Offer Code" id="getoffer_code">
                            </div>
                            <div class="form-group">
                                <label for="getoffer_amount" class="col-form-label">Offer in percentage (%):</label>
                                <input type="text" class="form-control" name="getoffer_amount" placeholder="Enter Offer in percentage (%)" id="getoffer_amount">
                            </div>
                            <div class="form-group">
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                url:"{{ URL::to('admin/promocode/delete') }}",
                data: {
                    id: id
                },
                method: 'POST', //Post method,
...
$('#getoffer_amount').keyup(function(){
    var val = $(this).val();
    if(isNaN(val)){
         val = val.replace(/[^0-9\.]/g,'');
         if(val.split('.').length>2) 

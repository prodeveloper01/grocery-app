                                    ...
                                    <td>
                                        @if (env('Environment') == 'sendbox')
                                            @if($payment->is_available == '1')
                                                <a class="badge badge-info px-2" onclick="myFunction()" style="color: #fff;">Active</a>
                                            @else
                                                <a class="badge badge-primary px-2" onclick="myFunction()" style="color: #fff;">Deactive</a>
                                            @endif
                                        @else
                                            @if($payment->is_available == '1')
...
function StatusUpdate(id,status) {
    swal({
        title: "Are you sure?",
        text: "Are you sure to change the status of payment ?",
        type: "warning",

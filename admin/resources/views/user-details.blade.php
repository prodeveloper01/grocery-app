    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <img src='{!! asset("public/assets/images/wallet.png") !!}' width="100px" alt="">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <img src='{!! asset("public/assets/images/referral.png") !!}' width="100px" alt="">
                                ...
                                <tr id="dataid{{$orders->id}}">
                                    ...
                                    <td>
                                        ...
                                        @elseif ($orders->status == '2')
                                            ...
                                            @endif
                                        @elseif ($orders->status == '3')
                                            <a data-toggle="tooltip" data-placement="top" onclick="StatusUpdate('{{$orders->id}}','4')" title="" data-original-title="Out for Delivery">
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if (data == 1) {
                    ...
                    $('#message').html("<div class='alert alert-danger' role='alert'>Please select Driver</div>");
                }
            },error:function(data){
